...
export function UserProfileDropdown() {
  ...
  let userRole = '';
  let partnerName = '';
  if(name && JSON.parse(name).Partner) {
    userName = JSON.parse(name).userEmail;
    userRole = JSON.parse(name).userRole;
    partnerName = JSON.parse(name).Partner.partnerName;
    ...
    <Dropdown drop="down" alignRight>
      ...
      >
        ...
        >
          ...
          <span className="text-dark-50 text-left font-weight-bolder font-size-base d-none d-md-inline mr-3">
           {userName}   <br></br>
